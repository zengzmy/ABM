...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks (count good_metabolism_turtles)/ (initial-population)"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks (count good_vision_turtles)/ (initial-population)"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot (count turtles) / (initial-population)"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks mean [sugar] of turtles"
...
@#$#@#$#@
<experiments>
  <experiment name="experiment" repetitions="20" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>count turtles</metric>
    <metric>mean-of-vision</metric>
    <metric>mean-of-metabolism</metric>
    <metric>mean [metabolism] of turtles</metric>
    <metric>mean [vision] of turtles</metric>
    <metric>(count turtles) / (initial-population)</metric>
    <metric>(count good_vision_turtles) / (initial-population)</metric>
    <metric>(count good_metabolism_turtles) / (initial-population)</metric>
    <metric>(count bad_vision_turtles) / (initial-population)</metric>
    <metric>(count bad_metabolism_turtles) / (initial-population)</metric>
